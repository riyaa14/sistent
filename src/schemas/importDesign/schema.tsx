      ...
      then: {
        properties: {
          file: {
            type: 'string',
            format: 'file',
            description: 'Browse the design file from your system. Make sure it's in a [supported format](https://docs.meshery.io/guides/configuration-management/importing-designs#supported-design-definition-formats).',
            'x-rjsf-grid-area': '12'
          }
        },
        required: ['file']
